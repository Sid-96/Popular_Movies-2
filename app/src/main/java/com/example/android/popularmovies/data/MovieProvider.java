...
public class MovieProvider extends ContentProvider {
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (sUriMatcher.match(uri)){
            case MOVIE_LIST: {
                count = sqLiteDatabase.delete(MovieEntry.TABLE_NAME, selection, selectionArgs);
                break;
            }
            case MOVIE_DETAIL: {
                count = sqLiteDatabase.delete(MovieEntry.TABLE_NAME, MovieEntry.COLUMN_ID + " = ?", selectionArgs);
                break;
            }
            default:
